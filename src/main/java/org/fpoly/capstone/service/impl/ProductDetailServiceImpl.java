...
//    Product product = this.productRepository.findById(Long.valueOf(request.getProductId()))
//        .orElseThrow(() -> new RuntimeException("Product not found"));
//    Category category = this.categoryRepository.findById(Long.valueOf(request.getCategoryId()))
//        .orElseThrow(() -> new RuntimeException("Category not found"));
//    Color color = this.colorRepository.findById(Long.valueOf(request.getColorId()))
//        .orElseThrow(() -> new RuntimeException("Color not found"));
//    Material material = this.materialRepository.findById(Long.valueOf(request.getMaterialId()))
//        .orElseThrow(() -> new RuntimeException("Material not found"));
//    Size size = this.sizeRepository.findById(Long.valueOf(request.getSizeId()))
