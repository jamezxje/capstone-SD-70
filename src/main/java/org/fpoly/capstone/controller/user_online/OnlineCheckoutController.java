...
////    public String onOpenCheckoutView(@RequestParam("cartDetailIds") List<Long> cartDetailIds, Model model) {
...
////        List<CartDetailResponse> cartDetailResponseList = this.cartDetailService.findCartDetailByIds(cartDetailIds);
//
